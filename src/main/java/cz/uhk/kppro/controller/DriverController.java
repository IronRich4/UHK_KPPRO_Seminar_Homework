...
public class DriverController {
    ...
    @Autowired
    public DriverController(DriverService driverService, DriverRepository driverRepository, CarService carService) {
        this.driverService = driverService;
        this.carService = carService;
    }

//    private ArrayList<Driver> drivers = new ArrayList<>();        // repository pro preskoceni service vrstvy

    @GetMapping("/")
    public String listAllDrivers(Model model) {
//        Driver driver = new Driver("modrá",5,"8H02536");
//        drivers.add(driver);
